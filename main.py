...
print(question[1])
user_answer = input("Введи свой ответ: ")
if user_answer.lower() == answer[1].lower():
    print("Правильно!")
    score += 1
else:
    print("Неправильно.")
...
print(question[2])
user_answer = input("Введи свой ответ: ")
if user_answer.lower() == answer[2].lower():
    print("Правильно!")
    score += 1
else:
    print("Неправильно.")
...
print(question[3])
user_answer = input("Введи свой ответ: ")
if user_answer.lower() == answer[3].lower():
    print("Правильно!")
    score += 1
else:
    print("Неправильно.")
...
print(question[4])
user_answer = input("Введи свой ответ: ")
if user_answer.lower() == answer[4].lower():
    print("Правильно!")
    score += 1
else:
    print("Неправильно.")
...
print(question[5])
user_answer = input("Введи свой ответ: ")
if user_answer.lower() == answer[5].lower():
    print("Правильно!")
    score += 1
else:
    print("Неправильно.")
...
print(question[6])
user_answer = input("Введи свой ответ: ")
if user_answer.lower() == answer[6].lower():
    print("Правильно!")
    score += 1
else:
    print("Неправильно.")
